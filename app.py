...
index 37cea9cae740d3c3ada84daf98e2f2d1c3ac773a..7d32b04a32a02a8f96073812163b31380cfff3ce 100644
--- a/README.md
+++ b/README.md
@@ -1,2 +1,13 @@
...
index 4f1d3411a336240e7a28718c56ba869fb8e7cf33..700085c2a7d8c4f333c90e41cd075ebba1f3d53a 100644
--- a/app.py
+++ b/app.py
@@ -1,97 +1,98 @@
-import json
...
+DEFAULT_INFO = (
 ...
 elements.append({
     ...
     "position": {"x": 930, "y": 350},
@@ -398,108 +399,108 @@ def dropdown_options_from_search(search_value):
...
+                "text-valign": "center",
         ...
         },
         {
             ...
             "style": {
                 ...
                 "border-width": 0,
                 "label": ""
@@ -508,65 +509,65 @@ def base_stylesheet():
         {
             "selector": "edge",
             "style": {
                 "width": 2,
...
+        }
 ...
 def edge_ids_for_subgraph(node_ids):
     ...
     for u, v in G.edges():
         if u in node_ids and v in node_ids:
@@ -588,268 +589,344 @@ def build_highlight_styles(selected_node_id, direction):
     else:
         impacted_nodes = (
             set(nx.ancestors(G, selected_node_id))
             | {selected_node_id}
...
+)
 ...
 @app.callback(
     ...
     State("direction", "value"),
     State("signal-search", "value"),
@@ -872,27 +949,28 @@ def update_view(tap_node_data, go_clicks, reset_clicks, direction, selected_sign
         return base_stylesheet(), message, selected_signal_name
...
index b06920894bcd049ac34b03e4da3582f2402b482a..b4f9df908ff62d3ec2ce83a19528ad580da1ad48 100644
--- a/requirements.txt
+++ b/requirements.txt
@@ -1,3 +1,4 @@
-dash
